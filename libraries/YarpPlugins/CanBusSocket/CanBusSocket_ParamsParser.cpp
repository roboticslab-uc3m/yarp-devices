...
bool CanBusSocket_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
    if (paramName =="port")
    {
        paramValue = m_port;
    ...
    if (paramName =="filterFunctionCodes")
    {
        if (m_filterFunctionCodes==true) paramValue = "true";
        else paramValue = "false";
        return true;
    }
...
std::string CanBusSocket_ParamsParser::getConfiguration() const
{
