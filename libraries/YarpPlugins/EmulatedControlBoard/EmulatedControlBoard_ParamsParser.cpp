...
bool EmulatedControlBoard_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
    if (paramName =="axes")
    {
    ...
    if (paramName =="jmcMs")
    {
        paramValue = std::to_string(m_jmcMs);
        return true;
    }
    if (paramName =="mode")
    {
    ...
    if (paramName =="genInitPos")
    {
        paramValue = std::to_string(m_genInitPos);
        return true;
    }
    if (paramName =="genJointTol")
    {
        paramValue = std::to_string(m_genJointTol);
        return true;
    }
    if (paramName =="genMaxLimit")
    {
        paramValue = std::to_string(m_genMaxLimit);
        return true;
    }
    if (paramName =="genMinLimit")
    {
        paramValue = std::to_string(m_genMinLimit);
        return true;
    }
    if (paramName =="genRefSpeed")
    {
        paramValue = std::to_string(m_genRefSpeed);
        return true;
    }
    if (paramName =="genEncRawExposed")
    {
        paramValue = std::to_string(m_genEncRawExposed);
        return true;
    }
    if (paramName =="genVelRawExposed")
    {
        paramValue = std::to_string(m_genVelRawExposed);
        return true;
    }
    if (paramName =="initPoss")
    {
        return false;
    }
    if (paramName =="jointTols")
    {
        return false;
    }
    if (paramName =="maxLimits")
    {
        return false;
    }
    if (paramName =="minLimits")
    {
        return false;
    }
    if (paramName =="refSpeeds")
    {
        return false;
    }
    if (paramName =="encRawExposeds")
    {
        return false;
    }
    if (paramName =="velRawExposeds")
    {
        return false;
    }
...
std::string EmulatedControlBoard_ParamsParser::getConfiguration() const
{
