...
bool Jr3Pci_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
    if (paramName =="names")
    {
        return false;
    ...
    if (paramName =="levogyrate")
    {
        if (m_levogyrate==true) paramValue = "true";
...
std::string Jr3Pci_ParamsParser::getConfiguration() const
{
