...
bool JointCalibrator_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
    if (paramName =="joints")
    {
    ...
    if (paramName =="block")
    {
        if (m_block==true) paramValue = "true";
        else paramValue = "false";
        return true;
    }
    if (paramName =="home")
    {
        paramValue = std::to_string(m_home);
        return true;
    }
    if (paramName =="homeVel")
    {
        paramValue = std::to_string(m_homeVel);
        return true;
    }
    if (paramName =="homeAcc")
    {
        paramValue = std::to_string(m_homeAcc);
        return true;
    }
    if (paramName =="park")
    {
        paramValue = std::to_string(m_park);
        return true;
    }
    if (paramName =="parkVel")
    {
        paramValue = std::to_string(m_parkVel);
        return true;
    }
    if (paramName =="parkAcc")
    {
        paramValue = std::to_string(m_parkAcc);
        return true;
    }
    if (paramName =="homes")
    {
    ...
    if (paramName =="homeVels")
    {
        return false;
    }
    if (paramName =="homeAccs")
    {
        return false;
    }
    if (paramName =="parks")
    ...
    if (paramName =="parkVels")
    {
        return false;
    }
    if (paramName =="parkAccs")
    {
        return false;
    }
...
std::string JointCalibrator_ParamsParser::getConfiguration() const
{
