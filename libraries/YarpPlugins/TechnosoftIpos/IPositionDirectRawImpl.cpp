...
bool roboticslab::TechnosoftIpos::setPositionRaw(int j, double ref)
{
    ...
    if (ptModeMs == 0)
    {
        return setExternalReferenceRaw(j, ref);
    }
    else
    {
        return setPtTargetRaw(j, ref);
    }
}

// -----------------------------------------------------------------------------

bool roboticslab::TechnosoftIpos::setExternalReferenceRaw(int j, double ref)
{
    //*************************************************************
...
bool roboticslab::TechnosoftIpos::setPtTargetRaw(int j, double ref)
{
    //*************************************************************
