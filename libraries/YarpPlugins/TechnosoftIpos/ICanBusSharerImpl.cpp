...
bool roboticslab::TechnosoftIpos::resetNodes()
{
    ...
    if( ! canDevicePtr->canWrite(canOutputBuffer, 1, &sent, false) ) // -- 0 (hace referencia al ID. Si est en 0 es como un broadcast) 2 (tamao del mensaje)
    {
...
bool roboticslab::TechnosoftIpos::interpretMessage(yarp::dev::CanMessage * message)
{
