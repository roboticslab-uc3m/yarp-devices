...
bool Wiimote_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
    if (paramName =="deviceId")
    {
        paramValue = std::to_string(m_deviceId);
        return true;
    }
    if (paramName =="calibZeroX")
    {
        paramValue = std::to_string(m_calibZeroX);
        return true;
    }
    if (paramName =="calibZeroY")
    {
        paramValue = std::to_string(m_calibZeroY);
        return true;
    }
    if (paramName =="calibZeroZ")
    {
        paramValue = std::to_string(m_calibZeroZ);
        return true;
    }
    if (paramName =="calibOneX")
    {
        paramValue = std::to_string(m_calibOneX);
        return true;
    }
    if (paramName =="calibOneY")
    {
        paramValue = std::to_string(m_calibOneY);
        return true;
    }
    if (paramName =="calibOneZ")
    {
        paramValue = std::to_string(m_calibOneZ);
        return true;
    }
...
std::string Wiimote_ParamsParser::getConfiguration() const
{
