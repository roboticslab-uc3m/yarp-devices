...
* \code{.unparsed}
* yarpdev --device SpaceNavigator --deadband 0.125 --fullScaleX 460.0 --fullScaleY 430.0 --fullScaleZ 440.0 --fullScaleRX 415.0 --fullScaleRY 405.0 --fullScaleRZ 435.0 --maxNoDataIterations 100
* \endcode
*
* \code{.unparsed}
