...
bool teo::TechnosoftIpos::setMinLimitRaw(double min)
{
    ...
    int sendMin = min * this->tr * (4096/360);  // Appply tr & convert units to encoder increments
...
bool teo::TechnosoftIpos::setMaxLimitRaw(double max)
{
    ...
    int sendMax = max * this->tr * (4096/360);  // Appply tr & convert units to encoder increments
