 ...
 * \defgroup cuiAbsolute PIC-Firmware
 *
 * @brief Creates an instance of teo::CheckCanBus.
 *
 * @section cuiAbsolute_legal Legal
 *
 ...
 * Then, build all. <br>
 * Finally, select programmer "MPLAB ICD 2", disconnect CAN-BUS connections, connect with the PIC and program it. <br>
 *
 * @section cuiAbsolute_running Running (assuming correct installation)
 *
 *
 * To test Cui Aboslute encoders are working properly, you need to start the program named "testCuiAbsolute" and see that the test passed correctly.
\verbatim
 ...
 * firmware/CuiAbsolute/Pic_source_2.0/main.cpp //
 *
 */
