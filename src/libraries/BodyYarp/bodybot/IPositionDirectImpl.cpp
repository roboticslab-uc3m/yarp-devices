...
bool teo::BodyBot::setPositionDirectMode() {
    ...
    for(int j=0;j<drivers.size();j++)
    {
        ...
        if ( ! drivers[j]->send(0x600,8,disableRPDO3) )
            return false;
        //*************************************************************
        ...
        if ( ! drivers[j]->send(0x600,8,mapSDOsub1) )
            return false;
        //* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
        ...
        if ( ! drivers[j]->send(0x600,8,mapSDOsub2) )
            return false;
        //*************************************************************
        ...
        if ( !  drivers[j]->send(0x600,8,enableRPDO3) )
            return false;
        //*************************************************************
        ...
        if ( ! drivers[j]->send(0x600,8,opMode) )
            return false;
        //*************************************************************
        ...
        if ( ! drivers[j]->send(0x600,8,subMode) )
            return false;
        //*************************************************************
        ...
        if ( ! drivers[j]->send(0x600,8,buffLength) )
            return false;
        //*************************************************************
        ...
        if ( ! drivers[j]->send(0x600,8,buffConf) )
            return false;
        //*************************************************************
        ...
        if ( ! drivers[j]->send(0x600,8,initPos) )
            return false;
        //*************************************************************
    }
    Time::delay(1);
